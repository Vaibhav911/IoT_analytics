...
#                             annual_data, monthly_data, daily_data, hourly_data)
    ...
    for sensor_set in sensor_sets:
        ...
        (values, labels) = organize_all_sensor_data(attributes, frequency, sensorIds, start_time, end_time, 
                             annual_data, monthly_data, daily_data, hourly_data)
        values = prepare_bar_graph(values)
        final_bar_graph_data.append({'labels': labels, 'values': values})
...
def prepare_heat_map(attributes, frequency, sensor_sets, start_time, end_time, 
                             annual_data, monthly_data, daily_data, hourly_data):
    sensorIds = [];
    for sensor_set in sensor_sets:
        for sensor in sensor_set:
...
def prepare_histogram(attributes, frequency, sensor_sets, start_time, end_time, 
                             annual_data, monthly_data, daily_data, hourly_data):
    sensorIds = [];
    for sensor_set in sensor_sets:
        for sensor in sensor_set:
