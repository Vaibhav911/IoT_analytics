        ...
        else//old sensor, but hour changed
        {
            ...
            else//it's a different date, will check for month and year
            {
                ...
                { 
                    ...
                    // console.log('awaiting for combine hourly data to dailydata');
...
async function prepare_server()//only push the most recent reading************************
{
...
{
    // console.log('******in cmbin hourly data to daily data**********');
    ...
    await Hour_Schema.find({sensorId: current_sensorId,
        ...
        (err, hourlyDataArray) =>
        {
            ...
            else
            {
                ...
                // console.log('before save hourly data to daily data in combine hourly data to daily data');

                async function save_hourlyData_to_dailyData()
                {
                    // console.log('in save hourly data to daily data in combine hourly data to daily data');
                    await dailyData.save(err => {
                        ...
                        {
                            // console.log('hourly data saved to daily data in combine hourly data to daily data');
...
{
    // console.log('***in combine daily_data to monthly data***');
    ...
    await Day_Schema.find({sensorId: current_sensorId,
                    ...
                    (err, dailyDataArray) => {
                        ...
                        {
                            // console.log('in combine daily data to monthly data');
                            // console.log('sensor Id: ' + current_sensorId);
                            // console.log('old month: ' + old_month);
                            // console.log('old year: ' + old_year);
                            // console.log('dailydatareie: ' + JSON.stringify(dailyDataArray));
                            ...
                            // console.log('monthlyData obj ' + monthlyData);
...
{
    console.log('in combine monthly data to annual data');
    var old_year = last_stored_months[index_prev_month_in_cache].year
    console.log('old year is ' + old_year + ', current sensorId: ' + current_sensorId);
    ...
    await Month_Schema.find({sensorId: current_sensorId,
                       ...
                       (err, monthlyDataArray) => {
                           ...
                           {
                               console.log("monthly data array " + JSON.stringify(monthlyDataArray))
